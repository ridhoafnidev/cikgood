			...
			<div class="panel-body">
				...
				<div class="col-sm-12">
					<div class="col-sm-7">
						<div>
							<p style="font-size:17px;font-family:'Times New Roman', Times, serif;">
								Setuju dibebankan pada mata annggaran berkenaan a.n Kuasa Pengguna Anggaran 
							</p>
							<?php
						...
						<div style="">
							<b>
								<p style="font-size:17px;font-family:'Times New Roman', Times, serif;">
									<?php echo $data2['pegawai'];?>
								</p>
							</b>
							<b>
								<p style="font-size:17px;font-family:'Times New Roman', Times, serif;margin-top:-10px">
									NIP. <?php echo $data2['nip'];?>
								</p>
							</b>
						</div>
					</div>
					<div class="col-sm-5">
						...
						<div style="">
							<b>
								<p style="font-size:17px;font-family:'Times New Roman', Times, serif;">
									<?php echo $data3['pegawai'];?>	
								</p>
							</b>
							<b>
								<p style="font-size:17px;font-family:'Times New Roman', Times, serif;margin-top:-10px">
									NIP.<?php echo $data3['nip'];?>
								</p>
							</b>
						</div>
					</div>
