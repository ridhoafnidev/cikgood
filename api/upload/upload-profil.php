...
$conn = new mysqli($servername, $username, $password, $dbname);
 ...
 $ImagePath = "http://arslyn.com/cikgood/backend/web/upload/images/guru/profil/$DefaultId.jpg";
 
 $ServerURL = "$DefaultId.jpg";

  $UpdateSQL = "UPDATE guru_profil SET nama = '$nama', photo_profile = '$ImageData', email = '$email', no_hp ='$no_hp' , tgl_lahir = '$tgl_lahir', jk = '$jk', provinsi_ktp = '$provinsi_ktp', kota_ktp = '$kota_ktp', kecamatan_ktp = '$kecamatan_ktp', alamat_ktp = '$alamat_ktp', provinsi_domisili = '$provinsi_domisili', kota_domisili = '$kota_domisili', kecamatan_domisili = '$kecamatan_domisili', alamat_domisili = '$alamat_domisili', biodata = '$biodata'WHERE id_guru ='$id_guru' ";
