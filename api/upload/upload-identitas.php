...
//   $UpdateSQL = "UPDATE guru_identitas SET nomor_ktp = '$nomor_ktp', photo_ktp = '$ServerURLKtp', photo_npwp = '$ServerURLNpwp', nama_bank ='$nama_bank' , nomor_rekening = '$nomor_rekening', nama_pemilik_rekening = '$nama_pemilik_rekening' WHERE guru_id ='$guru_id' ";
